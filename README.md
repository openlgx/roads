...
**Authoritative phased plan:** see [ROADMAP.md](ROADMAP.md). **Server shape (Neon metadata, Storage blobs, Edge Functions):** see [docs/backend.md](docs/backend.md). **Normative upload API:** [docs/api-contract.md](docs/api-contract.md). **Operator setup:** [docs/setup-hosted-alpha.md](docs/setup-hosted-alpha.md). **Single-council pilot:** [docs/pilot-readiness.md](docs/pilot-readiness.md) (checklists, GIS URLs, scripts).
